...
if(isset($_POST["category"])){
	...
	echo "
		...
		<div class='nav nav-pills nav-stacked selectedCategoryList'>
...
if(isset($_POST["brand"])){
	...
	echo "
		...
		<div class='nav nav-pills nav-stacked selectBrandList'>
				...
				<div class='col-md-4'>
							...
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<img class='center-block' src='product_images/$pro_image' style='width:250px; height:240px'/>
								</div>
								...
								<div class='panel-heading' style='font-size: 20px;'>€$pro_price
									...
									<button name='id' class='btnDetails mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent' type='submit' value='$pro_id'>Details</button>
                                    </form>
...
if(isset($_POST["get_seleted_Category"]) || isset($_POST["selectBrand"]) || isset($_POST["search"])){
	...
	}elseif( isset($_POST["selectBANDC"])) {
		
		$bid = $_POST["brand_id"];
		$cid = $_POST["cat_id"];

		$sql = "SELECT * FROM products WHERE product_brand = '$id' AND product_cat = '$cid'";
...
if (isset($_POST["Common"])) {
	...
	if (isset($_SESSION["uid"])) {
		...
		$sql = "SELECT a.product_id,a.product_title,a.product_color,a.product_price,a.product_image,b.id,b.qty FROM products a,cart b WHERE a.product_id=b.p_id AND b.user_id='$_SESSION[uid]'";
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
							...
							<input type="hidden" name="business" value="shoppingcart@vadaza.be">
